...
try {
    $pdo = getDbConnection();
    $salesData = $pdo->query('SELECT DATE(created_at) AS date, COUNT(*) AS orders, COALESCE(SUM(total_amount), 0) AS revenue FROM orders GROUP BY DATE(created_at) ORDER BY date DESC LIMIT 7')->fetchAll();
} catch (Throwable $e) {
    $salesData = [];
}
?>
    ...
    <div class="dashboard-shell">
        <aside class="sidebar">
            ...
            <nav class="nav" aria-label="Sidebar navigation">
                ...
                <a class="nav-item active" href="sales.php"><span class="nav-icon"></span>Sales</a>
        ...
        <div class="content">
            <header class="topbar">
                <div class="topbar-title"><span class="burger" aria-label="Menu button"><span></span><span></span><span></span></span><span>Sales</span></div>
                ...
                <div class="wrap">
                    <div class="panel">
                        <div class="stat-grid">
                            ...
                            <div class="stat">
                                <strong><?php echo (int) array_sum(array_map(static fn($row) => (int) ($row['orders'] ?? 0), $salesData)); ?></strong>
                                <span>Orders</span>
                            </div>
                            <div class="stat">
